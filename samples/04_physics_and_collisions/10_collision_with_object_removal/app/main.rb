...
require 'app/vector2d'
require 'app/paddle'
require 'app/ball'
require 'app/linear_collider'
...
begin
  ...
  def reset_game(args)
    ...
    return unless args.state.game_over_at != 0 && args.state.game_over_at.elapsed_time == 60
  ...
  def calc_collision(args)
    ...
    args.state.bricks.each do |b|
      next unless b.rect.intersect_rect?(ball_rect)
