  ...
  class Runtime
    module CBridge
      ...
      def finger_up touchid, sender = false
        ...
        if @args.inputs.touch[touchid] && @args.inputs.touch[touchid].x < 640
          @args.inputs.finger_left = nil
        elsif @args.inputs.touch[touchid] && @args.inputs.touch[touchid].x > 640
  ...
  * ERROR:
  ...
  S
      ...
      def __controller_analog_set_last_active_if_needed__ target_controller, raw_analog_value
        return if raw_analog_value.abs <= 1600
      ...
      def set_resize_occurred value
        @args.events.resize_occurred = value
      end
